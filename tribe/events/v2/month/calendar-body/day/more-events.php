...
<div class="tribe-events-calendar-month__more-events">
	<!-- <a
        ...
        data-more-events="<?php echo esc_attr( $more_events ); ?>"
        data-url="<?php echo esc_url( $more_url ); ?>"
        onclick="loadMoreEvents(this)"
	>

        他<?php echo esc_html( $more_events ); ?>件
	</a> -->
        <a
